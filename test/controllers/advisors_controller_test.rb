...
class AdvisorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advisor" do
    assert_difference('Advisor.count') do
      post advisors_url, params: { advisor: { recurring: @advisor.recurring, start_time: @advisor.start_time } }
    end
  ...
  test "should update advisor" do
    patch advisor_url(@advisor), params: { advisor: { recurring: @advisor.recurring, start_time: @advisor.start_time } }
